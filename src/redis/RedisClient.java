...
public class RedisClient {
    ...
    public  RedisClient(String ip,int port,String master){
        intiPool(ip,port);
        initShardePool(ip,port,master);
    }

    private void initShardePool(String ip,int port ,String master) {
     ...
     //   shards.add(new JedisShardInfo(ip, port,master));不带密码
        JedisShardInfo jedisShardInfo = new JedisShardInfo(ip,port,master);
        jedisShardInfo.setPassword("123!@#qqw");
    ...
    private void intiPool(String ip ,int port) {
        JedisPoolConfig config  = new JedisPoolConfig();
        config.setMaxTotal(20);
        config.setMaxIdle(5);
     ...
     //   jedisPool = new JedisPool(config,ip,port);
        jedisPool = new JedisPool(config,ip,port,5000,"123!@#qqw");
    ...
    public  static  void  main(String args[]){
        RedisClient redisClient = new RedisClient("192.168.30.99",6379,"master");
        redisClient.show();
    }

    private  void reflectTestOne(int a ,int b){
        System.out.println("sum:"+(a+b));
    }

    private  void reflectTestwo(){
        System.out.println("test two");
    }

    private  String  reflectThree(String a,String b){
       return  a+b;
    }

    public void reflectFour(){
